    ...
    <el-card class="box-card">
      <div>
        ...
        <el-table :data="tableData" style="width: 100%" border>
          ...
          <el-table-column header-align="center" prop="order_number" label="订单编号"> </el-table-column>
          <el-table-column header-align="center" prop="order_price" label="订单价格"> </el-table-column>
          <el-table-column header-align="center" prop="ok" label="是否付款">
						<template slot-scope="scope">
								<el-tag :type="scope.row.ok=='已付款'?'':'danger'">{{scope.row.ok}}</el-tag>
						</template>
					</el-table-column>
          <el-table-column header-align="center" prop="is_send" label="是否发货"> </el-table-column>
          <el-table-column header-align="center" prop="create_time" label="下单时间">
            <!-- <template slot-scope="scope">
              <el-switch v-model="scope.row.mg_state" @change="aa(scope.row)"></el-switch>
            </template> -->
          </el-table-column>
          <el-table-column header-align="center" prop="name" label="操作">
            <template slot-scope="scope">
              <el-button size="mini" type="primary" icon="el-icon-edit" @click="bj(scope.$index)"></el-button>
              <el-button size="mini" type="danger" icon="el-icon-delete" @click="del(scope.$index)"></el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 表格 -->
...
export default {
  ...
  methods: {
    getuser() {
      this.$http({ method: 'get', url: '/api/orders' }).then((res) => {
        console.log(res)
