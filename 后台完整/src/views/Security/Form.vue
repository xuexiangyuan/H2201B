    ...
    <el-card class="box-card">
      <div>
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="" label="离职时间" sortable> </el-table-column>
          ...
          <el-table-column prop="providentFundBase" label="社保基数"> </el-table-column>
          <el-table-column prop="socialSecurityBase" label="公积金基数"> </el-table-column>
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button type="text" @click="lock(scope.row)">查看详情</el-button>
            </template>
          </el-table-column>
        </el-table>
...
<script>
import {security,securitylock} from '../api/security'
export default {
  data() {
    return {
			tableData:[],
	...
	methods: {
		getlist(){
			security().then(res=>{
				...
				this.panum.total=res.data.total
			})
		},
