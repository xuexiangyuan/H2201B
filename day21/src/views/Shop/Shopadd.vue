	...
	<div class="top">
		...
		<el-tabs tab-position="left" :before-leave="tabchange">
			...
			<el-tab-pane label="商品图片">
				<el-upload class="upload-demo" action="http://175.27.228.178:3434/api/private/v1/upload"
					:on-success="postImg" list-type="picture" :headers="headers">
			...
			<el-tab-pane label="商品内容">
				<quill-editor v-model="richText" ref="myQuillEditor" :options="editorOption">
				</quill-editor>
			</el-tab-pane>
